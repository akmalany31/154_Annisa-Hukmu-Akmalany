...
use Modules\Shop\Database\Seeder\ShopDatabaseSeeder;
use Modules\Shop\Database\Seeders\ShopDatabaseSeeder as SeedersShopDatabaseSeeder;
use App\Models\User;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($this->command->confirm('Do you want to seed some sample products ?')) {
            $this->call(SeedersShopDatabaseSeeder::class);
        }
    }
}
