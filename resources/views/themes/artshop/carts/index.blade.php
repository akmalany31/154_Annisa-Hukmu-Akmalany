                            ...
                            <li class="list-group-item py-3 border-top">
                                <div class="row align-items-center">
                                    <div class="col-6 col-md-6 col-lg-7">
                                        <div class="d-flex">
                                            <img src="{{ asset('themes/artshop/assets/images/' . $item->product->featured_image) }}" alt="Ecommerce" style="height: 70px;">
                                            <div class="ms-3">
                    ...
                    <div class="col-12 col-lg-4 col-md-5">
                        <div class="mb-5 card mt-6 shadow">
                            <div class="card-body p-6">
                                ...
                                <p>
                                    <small>
                                       Silakan mengunjungi kasir untuk melanjutkan pembayaran!
                                    </small>
                                </p>
                                </div>
                            </div>
